...
namespace MarcelloDB.Index
{
    public partial class IndexDefinition<T>
    {
            ...
            (Func<T, CompoundValue<TAtt1, TAtt2>> valueFunc, [CallerMemberName] string callerMember = "")
        {
            ...
            {
                return (UniqueIndexedValue<T, TAtt1, TAtt2>)IndexedValues.First(v => v.PropertyName == callerMember);
            }
        }
            ...
            (Func<T, CompoundValue<TAtt1, TAtt2, TAtt3, TAtt4>> valueFunc, [CallerMemberName] string callerMember = "")
        {
            ...
            {
                return (UniqueIndexedValue<T, TAtt1, TAtt2, TAtt3, TAtt4>)IndexedValues.First(v => v.PropertyName == callerMember);
            }
        }
            ...
            (Func<T, CompoundValue<TAtt1, TAtt2, TAtt3, TAtt4, TAtt5>> valueFunc, [CallerMemberName] string callerMember = "")
        {
            ...
            {
                return (UniqueIndexedValue<T, TAtt1, TAtt2, TAtt3, TAtt4, TAtt5>)IndexedValues.First(v => v.PropertyName == callerMember);
            }
        }
            ...
            (Func<T, CompoundValue<TAtt1, TAtt2, TAtt3, TAtt4, TAtt5, TAtt6>> valueFunc, [CallerMemberName] string callerMember = "")
        {
            ...
            {
                return (UniqueIndexedValue<T, TAtt1, TAtt2, TAtt3, TAtt4, TAtt5, TAtt6>)IndexedValues.First(v => v.PropertyName == callerMember);
            }
        }
            ...
            (Func<T, CompoundValue<TAtt1, TAtt2, TAtt3, TAtt4, TAtt5, TAtt6, TAtt7>> valueFunc, [CallerMemberName] string callerMember = "")
        {
            ...
            {
                return (UniqueIndexedValue<T, TAtt1, TAtt2, TAtt3, TAtt4, TAtt5, TAtt6, TAtt7>)IndexedValues.First(v => v.PropertyName == callerMember);
            }
        }
            ...
            (Func<T, CompoundValue<TAtt1, TAtt2, TAtt3, TAtt4, TAtt5, TAtt6, TAtt7, TAtt8>> valueFunc, [CallerMemberName] string callerMember = "")
        {
            ...
            {
                return (UniqueIndexedValue<T, TAtt1, TAtt2, TAtt3, TAtt4, TAtt5, TAtt6, TAtt7, TAtt8>)IndexedValues.First(v => v.PropertyName == callerMember);
            }
        }
